...
#ifndef PID_PROTOCOL_H
#define PID_PROTOCOL_H
...
#define EXCHANGE_H_L_BIT(data)                                                                                         \
  ((((data) << 24) & 0xFF000000) | (((data) << 8) & 0x00FF0000) | (((data) >> 8) & 0x0000FF00) |                       \
   (((data) >> 24) & 0x000000FF)) // 交换高低字节

#define COMPOUND_32BIT(data)                                                                                           \
  (((*(data - 0) << 24) & 0xFF000000) | ((*(data - 1) << 16) & 0x00FF0000) | ((*(data - 2) << 8) & 0x0000FF00) |       \
